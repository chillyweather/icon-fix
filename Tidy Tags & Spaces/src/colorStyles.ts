...
export const dsBlue = setColorStyle("ds-admin/Blue", "00A7E1");
...
export const dsSpacingMarker = setColorStyle("ds-admin/Spacings", "E0851D");
export const dsPaddingsMarker = setColorStyle("ds-admin/Paddings", "A0B802");
